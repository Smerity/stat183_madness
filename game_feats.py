...
def get_gamefeats_for_seasons():
  ...
  def create_gamefeats(season, teamA, teamB):
    f = {}
  ...
  for season in seasons:
    ...
    for i in xrange(len(teams) - 1):
      ...
      for j in xrange(i + 1, len(teams)):
        teamB = teams[j]
        gamefeats[(teamA, teamB)] = create_gamefeats(season, teamA, teamB)
    #
...
def get_gamefeats():
  ...
  sgamefeats = get_gamefeats_for_seasons()
